...
/*				try{
				...
				//result = key.toString() + COLON + matchedColsHolder + PIPE + differedColssHolder + PIPE + existsOnlyinSource + PIPE + existsOnlyinTarget + PIPE + notUpdateDtoNullCols  ;
				context.write(new Text(result), NullWritable.get());
